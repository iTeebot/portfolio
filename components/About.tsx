...
export default function About() {
  ...
  return (
    <section id="about" className="py-16 sm:py-24 md:py-32 bg-zinc-50 dark:bg-black" ref={ref}>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4 sm:space-y-6">
            ...
            <div className="pt-4 sm:pt-6 md:pt-8">
              <h3 className="text-xs sm:text-sm font-semibold text-zinc-500 dark:text-zinc-500 uppercase tracking-wider mb-3 sm:mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {['AI/ML', 'IoT', 'Web Development', 'Mobile Apps', 'Cloud Infrastructure', 'Cybersecurity', 'Automation', 'Embedded Systems'].map((spec) => (
                  <span
                    key={spec}
                    className="px-3 py-1.5 sm:px-4 sm:py-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-full text-xs sm:text-sm text-zinc-700 dark:text-zinc-300"
                  >
                    {spec}
                  </span>
                ))}
          ...
          <motion.div variants={itemVariants} className="space-y-4 sm:space-y-6">
            {/* Mission */}
            <div className="border-l-2 border-zinc-900 dark:border-white pl-4 sm:pl-6">
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                <Target className="w-4 h-4 sm:w-5 sm:h-5 text-zinc-900 dark:text-white flex-shrink-0" />
                <h3 className="text-lg sm:text-xl font-serif font-semibold text-zinc-900 dark:text-white">
                  Mission
                </h3>
              </div>
            ...
            <div className="border-l-2 border-zinc-900 dark:border-white pl-4 sm:pl-6">
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                <Eye className="w-4 h-4 sm:w-5 sm:h-5 text-zinc-900 dark:text-white flex-shrink-0" />
                <h3 className="text-lg sm:text-xl font-serif font-semibold text-zinc-900 dark:text-white">
                  Vision
                </h3>
              </div>
            ...
            <div className="border-l-2 border-zinc-900 dark:border-white pl-4 sm:pl-6">
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-zinc-900 dark:text-white flex-shrink-0" />
                <h3 className="text-lg sm:text-xl font-serif font-semibold text-zinc-900 dark:text-white">
                  Approach
                </h3>
              </div>
